...
class ParameterMap implements ArrayAccess, IteratorAggregate, Countable, JsonSerializable
{
    use StaticCreator;
    ...
    /**
     * @param array<string, ParameterInterface> $items
     */
    ...
    public function set(string $name, ParameterInterface $item): self
    {
    ...
    public function __get(string $name): ParameterInterface
    {
        return $this->offsetGet($name);
    }

    public function __set(string $name, ParameterInterface $item): void
    {
        $this->offsetSet($name, $item);
    }
